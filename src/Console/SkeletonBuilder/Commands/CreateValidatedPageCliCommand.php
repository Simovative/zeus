 ...
 * @author shartmann
 */
class CreateValidatedPageCliCommand extends Command {
	const ARG_NAME = 'name';
	...
	protected function configure() {
		$this
			...
			->setHelp('This command helps you in creating a new form.')
			->addArgument(self::ARG_NAME, InputArgument::REQUIRED, 'The name of the form')
			->addArgument(self::ARG_BUNDLE, InputArgument::REQUIRED, 'Which bundle to build the form for')
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		try {
			$this->pageTemplateBuilder->generate(
				...
				PageTemplateBuilder::TYPE_VALIDATED_PAGE
			);
